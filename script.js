...
console.log ('код специально оставила в таком виде, так как считаю, что важно видеть красивое написание кода, а не отсутствие прокрутки внутри данного блока')
